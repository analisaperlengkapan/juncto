...
Visitors queue service is used for managing the visitors queue for the Juncto video meetings by keeping visitors websocket connections opened and when a moderator opens the meeting, the visitors are notified and allowed to join the meeting.
