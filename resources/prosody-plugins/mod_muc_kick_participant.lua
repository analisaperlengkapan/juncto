...
-- the correct jungasi we fined based on the display name and the number provided
...
function is_participant_match(pr, number, participantId)
    if number then
        ...
        return is_sip_jungasi(pr) and displayName and starts_with(displayName, number);
