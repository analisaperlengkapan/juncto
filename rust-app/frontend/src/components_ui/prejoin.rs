...
pub fn PrejoinScreen(
    on_join: Callback<(String, bool, bool, Option<String>, Option<String>)>,
) -> impl IntoView {
    ...
    let handle_join = move |_| {
        ...
        on_join.call((
            ...
            is_mic_on.get_untracked(),
            is_camera_on.get_untracked(),
            selected_audio_device.get_untracked(),
            selected_video_device.get_untracked()
        ));
    };
