...
pub fn Toolbox(
    ...
    is_host: Signal<bool>,
    _is_lobby_enabled: ReadSignal<bool>,
    is_recording: ReadSignal<bool>,
    on_toggle_lock: Callback<()>,
    _on_toggle_lobby: Callback<()>,
    on_toggle_recording: Callback<()>,
    on_invite: Callback<()>,
    on_toggle_chat: Callback<()>,
    on_settings: Callback<()>,
    on_polls: Callback<()>,
    _on_shortcuts: Callback<()>,
    on_speaker_stats: Callback<()>,
    _on_virtual_background: Callback<()>,
    _on_feedback: Callback<()>,
    on_raise_hand: Callback<()>,
    on_screen_share: Callback<()>,
    _on_share_video: Callback<()>,
    _on_stop_share_video: Callback<()>,
    _is_sharing_video: Signal<bool>,
        ...
        <div class=format!("toolbox bg-gray-900 border-t border-gray-800 p-3 flex flex-wrap items-center justify-center gap-2 sm:gap-4 {}", class) style=style>
            ...
            <div class="flex items-center space-x-2">
                ...
                <div class="flex bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
                    <button on:click=move |_| on_polls.call(()) class="px-3 py-2 hover:bg-gray-700 text-gray-300 transition-colors border-r border-gray-700 text-sm font-medium">"Polls"</button>
