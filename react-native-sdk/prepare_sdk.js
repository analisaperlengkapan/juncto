...
const androidSourcePath = '../android/sdk/src/main/java/org/juncto/meet/sdk';
const androidMainSourcePath = '../android/sdk/src/main/res';
const androidTargetPath = './android/src/main/java/org/juncto/meet/sdk';
...
fs.copyFileSync(
    `${iosSrcPath}/JunctoAudioSession.m`,
    `${iosDestPath}/JunctoAudioSession.m`
);
fs.copyFileSync(
    `${iosSrcPath}/JunctoAudioSession.h`,
    `${iosDestPath}/JunctoAudioSession.h`
);
fs.copyFileSync(
    `${iosSrcPath}/JunctoAudioSession+Private.h`,
    `${iosDestPath}/JunctoAudioSession+Private.h`
);
fs.copyFileSync(
