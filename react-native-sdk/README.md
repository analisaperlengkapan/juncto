# <p align="center">Juncto React Native SDK</p>


## Installation
Inside your project, run;
```console
npm i @juncto/react-native-sdk
```
...
```console
node node_modules/@juncto/react-native-sdk/update_dependencies.js
```
...
https://github.com/juncto/juncto-sdk-samples/tree/master/react-native
...
```javascript
  <JunctoMeeting
    ...
    serverURL = { 'https://meet.juncto.net/' }
...
https://juncto.github.io/handbook/docs/dev-guide/dev-guide-react-native-sdk
