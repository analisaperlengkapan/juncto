...
export interface JunctoRefProps {
    close: Function;
...
/**
 * Main React Native SDK component that displays a Juncto conference and gets all required params as props
 */
export const JunctoMeeting = forwardRef<JunctoRefProps, IAppProps>((props, ref) => {
    ...
    useLayoutEffect(() => {
         ...
         * Without this change the call remains active without having the juncto screen.
        */
        return () => {
            const dispatch = app.current?.state?.store?.dispatch;
