...
/**
 * Tests the recording and live-streaming functionality of JunctoService (including relevant webhooks) exercising the iFrame API
...
describe('Recording and live-streaming', () => {
    ...
    /**
     * Starts recording and asserts that the expected iFrame and JunctoService events are received.
    ...
    /**
     * Stops recording and asserts that the expected iFrame and JunctoService events are received.
     * @param command whether to use the "command" or the "function" iFrame API.
     */
