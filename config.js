 ...
 * https://juncto.github.io/handbook/docs/dev-guide/dev-guide-configuration
 */
...
var config = {
    ...
    hosts: {
        // XMPP domain.
        domain: 'juncto.example.com',

        // When using authentication, domain for guest users.
        // anonymousdomain: 'guest.example.com',

        // Domain for authenticated users. Defaults to <domain>.
        // authdomain: 'juncto.example.com',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.juncto.example.com',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'juncto.example.com',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://juncto.example.com/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    websocket: 'wss://juncto.example.com/' + subdir + 'xmpp-websocket',

    // websocketKeepAliveUrl: 'https://juncto.example.com/' + subdir + '_unlock',
    ...
    // https://github.com/juncto/juncto/issues/7376
    // focusUserJid: 'focus@auth.juncto.example.com',

    // Option to send conference requests to juncofo over http (requires nginx rule for it)
    // conferenceRequestUrl:
    //   'https://<!--# echo var="http_host" default="juncto.example.com" -->/' + subdir + 'conference-request/v1',
    ...
    testing: {
        ...
        // Enables the test specific features consumed by juncto-torture
        // testMode: false,
    ...
    // Enabling this will run the lib-juncto no audio detection module which
    ...
    // Enabling this will run the lib-juncto noise detection module which will
    ...
    // used by browsers that return true from lib-juncto's
    ...
    //     // by default uses:
    //     // 'https://juncto.example.com/static/oauth.html'
    //     redirectURI:
    //          'https://juncto.example.com/subfolder/static/oauth.html',
    // },
    ...
    //    // consentLearnMoreLink: 'https://juncto.org/meet/consent',
    // },
    ...
    //     // depends on junbri configuration)
    //     enabled: false,
    ...
    //    helpLink: 'https://juncto.org/live'
    // },
    ...
    // Moves all Juncto 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    // Use TURN/UDP servers for the juncto-junctobridge connection (by default
    ...
    // configuration (for example when 3 buttons are displayed) the default juncto configuration will be used.
    ...
    // When there isn't an override for a certain configuration the default juncto configuration will be used.
    // The order of the buttons in the array is preserved.
    ...
    // the webrtc stats) as it is done in the juncto-torture bandwidth
    // estimation tests.
    // gatherStats: false,
    ...
    p2p: {
        ...
        // through the JUNCTOBRIDGE and use the peer to peer connection instead. When a
        // 3rd participant joins the conference will be moved back to the JUNCTOBRIDGE
        // connection.
        enabled: true,
        ...
        stunServers: [
            ...
            // { urls: 'stun:juncto.example.com:3478' },
            { urls: 'stun:meet-juncto.net-turnrelay.juncto.net:443' },
        ],
    },
    ...
    analytics: {
        ...
        // rtcstatsEndpoint: wss://rtcstats-server-pilot.juncto.net/,
        ...
        // Array of script URLs to load as lib-juncto "analytics handlers".
        // scriptURLs: [
    ...
    // Information about the juncto instance we are connecting to, including
    ...
    //     url: 'https://chrome.google.com/webstore/detail/junctoings/kglhbbefdnlheedjiejgomgmfplipfeb',
    //     edgeUrl: 'https://microsoftedge.microsoft.com/addons/detail/junctoings/eeecajlpbgjppibfledfihobcabccihn',

    //     // Extensions info which allows checking if they are installed or not
    //     chromeExtensionsInfo: [
    //         {
    //             id: 'kglhbbefdnlheedjiejgomgmfplipfeb',
    //             path: 'juncto-logo-48x48.png',
    //         },
    //         // Edge extension info
    //         {
    ...
    //             macos: 'https://github.com/juncto/juncto-electron/releases/latest/download/juncto.dmg',
    //             windows: 'https://github.com/juncto/juncto-electron/releases/latest/download/juncto.exe'
    //         },
    //         enabled: false
    //     },
    //     // If true, any checks to handoff to another application will be prevented
    ...
    //         appScheme: 'org.juncto.meet',
    //         // Custom URL for downloading ios mobile app.
    //         downloadLink: 'https://itunes.apple.com/us/app/juncto/id1165103905',
    //     },
    ...
    //         downloadLink: 'https://play.google.com/store/apps/details?id=org.juncto.meet',
    //         // Android app package name.
    //         appPackage: 'org.juncto.meet',
    //         fDroidUrl: 'https://f-droid.org/en/packages/org.juncto.meet/',
    //     }
    // },

    // // The terms, privacy and help centre URL's.
    // legalUrls: {
    //     helpCentre: 'https://web-cdn.juncto.net/faq/meet-faq.html',
    //     privacy: 'https://juncto.org/meet/privacy',
    //     terms: 'https://juncto.org/meet/terms'
    // },
     ...
     None of the fields are mandatory and the response must have the shape:
    {
        ...
        // https://github.com/juncto/juncto/blob/master/react/features/base/icons/svg/index.ts
        ...
        // https://github.com/juncto/juncto/tree/master/resources/custom-theme/custom-theme.json
        // For a short explanations on each of the tokens, please check:
        // https://github.com/juncto/juncto/blob/master/react/features/base/ui/Tokens.ts
    ...
    */
    ...
    // moderatedRoomServiceUrl: 'https://moderated.juncto.example.com',
    ...
    // This property is related to the use case when juncto is used via the IFrame API. When the property is true
    // juncto will use the local storage of the host page instead of its own. This option is useful if the browser
    ...
    // List of undocumented settings used in juncto
    /**
     ...
     * which is retrieved internally by juncto meet) (e.g. https://meet.juncto.net/someMeeting
     * can become https://brandedDomain/roomAlias)
     */
    // brandingRoomAlias: null,

    // List of undocumented settings used in lib-juncto
    /**
    ...
    */
    ...
    // Logging
    // logging: {
    //      // Default log level for the app and lib-juncto.
    ...
    //     // https://github.com/juncto/excalidraw-backend
...
// Set the default values for JunctoService customers
if (enableJunctoService) {
    config.dialInNumbersUrl = 'https://conference-mapper.juncto.net/v1/access/dids';
    config.dialInConfCodeUrl = 'https://conference-mapper.juncto.net/v1/access';
