 ...
 * with those passed to JunctoMeetView.join when joining a conference.
 */
@property (nonatomic, nullable) JunctoMeetConferenceOptions *defaultConferenceOptions;

/**
 * Custom RTCAudioDevice implementation.
 * https://github.com/juncto/webrtc/blob/M124/sdk/objc/components/audio/RTCAudioDevice.h
...
- (JunctoMeetConferenceOptions *_Nonnull)getInitialConferenceOptions;
