...
#import "JunctoMeet+Private.h"
#import "JunctoMeetConferenceOptions+Private.h"
#import "JunctoMeetView+Private.h"
...
#if !defined(JUNCTO_MEET_SDK_LITE)
#import <RNGoogleSignin/RNGoogleSignin.h>
#import "Dropbox.h"
#endif

@implementation JunctoMeet {
...
+ (instancetype)sharedInstance {
    static JunctoMeet *sharedInstance = nil;
...
-    (BOOL)application:(UIApplication *)application
  continueUserActivity:(NSUserActivity *)userActivity
    ...
    JunctoMeetConferenceOptions *options = [self optionsFromUserActivity:userActivity];
    if (options) {
        [JunctoMeetView updateProps:[options asProps]];
        return true;
    }
...
- (BOOL)application:(UIApplication *)app
    ...
    JunctoMeetConferenceOptions *conferenceOptions = [JunctoMeetConferenceOptions fromBuilder:^(JunctoMeetConferenceOptionsBuilder *builder) {
        builder.room = [url absoluteString];
    }];
    [JunctoMeetView updateProps:[conferenceOptions asProps]];
...
- (JunctoMeetConferenceOptions *)getInitialConferenceOptions {
    if (_launchOptions[UIApplicationLaunchOptionsURLKey]) {
        NSURL *url = _launchOptions[UIApplicationLaunchOptionsURLKey];
        return [JunctoMeetConferenceOptions fromBuilder:^(JunctoMeetConferenceOptionsBuilder *builder) {
            builder.room = [url absoluteString];
        }];
    } else {
...
- (BOOL)isCrashReportingDisabled {
    NSUserDefaults *userDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"juncto-default-preferences"];
    return [userDefaults stringForKey:@"isCrashReportingDisabled"];
}

- (JunctoMeetConferenceOptions *)optionsFromUserActivity:(NSUserActivity *)userActivity {
...
- (void)setDefaultConferenceOptions:(JunctoMeetConferenceOptions *)defaultConferenceOptions {
