/*
 * Copyright @ 2018-present Juncto, Inc.
 * Copyright @ 2017-2018 Juncto Pty Ltd
 *
...
- (void)join:(JunctoMeetConferenceOptions *)options {
...
- (void)hangUp {
    ExternalAPI *externalAPI = [[JunctoMeet sharedInstance] getExternalAPI];
 ...
 *
 * - JunctoMeet.defaultConferenceOptions
 * - This function's parameters
 * - Some extras which are added by this function
 */
- (void)setProps:(NSDictionary *_Nonnull)newProps {
    NSMutableDictionary *props = mergeProps([[JunctoMeet sharedInstance] getDefaultProps], newProps);
    ...
    if (rootView) {
        ...
        RCTBridge *bridge = [[JunctoMeet sharedInstance] getReactBridge];
        rootView
