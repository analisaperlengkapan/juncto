/*
 * Copyright @ 2017-present Juncto, Inc.
 *
...
// Events
static NSString * const hangUpAction = @"org.juncto.meet.HANG_UP";
static NSString * const setAudioMutedAction = @"org.juncto.meet.SET_AUDIO_MUTED";
static NSString * const sendEndpointTextMessageAction = @"org.juncto.meet.SEND_ENDPOINT_TEXT_MESSAGE";
static NSString * const toggleScreenShareAction = @"org.juncto.meet.TOGGLE_SCREEN_SHARE";
static NSString * const retrieveParticipantsInfoAction = @"org.juncto.meet.RETRIEVE_PARTICIPANTS_INFO";
static NSString * const openChatAction = @"org.juncto.meet.OPEN_CHAT";
static NSString * const closeChatAction = @"org.juncto.meet.CLOSE_CHAT";
static NSString * const sendChatMessageAction = @"org.juncto.meet.SEND_CHAT_MESSAGE";
static NSString * const setVideoMutedAction = @"org.juncto.meet.SET_VIDEO_MUTED";
static NSString * const setClosedCaptionsEnabledAction = @"org.juncto.meet.SET_CLOSED_CAPTIONS_ENABLED";
static NSString * const toggleCameraAction = @"org.juncto.meet.TOGGLE_CAMERA";
static NSString * const showNotificationAction = @"org.juncto.meet.SHOW_NOTIFICATION";
static NSString * const hideNotificationAction = @"org.juncto.meet.HIDE_NOTIFICATION";
static NSString * const startRecordingAction = @"org.juncto.meet.START_RECORDING";
static NSString * const stopRecordingAction = @"org.juncto.meet.STOP_RECORDING";
static NSString * const overwriteConfigAction = @"org.juncto.meet.OVERWRITE_CONFIG";
static NSString * const sendCameraFacingModeMessageAction = @"org.juncto.meet.SEND_CAMERA_FACING_MODE_MESSAGE";
