...
#import "JunctoMeetUserInfo+Private.h"

@implementation JunctoMeetConferenceOptionsBuilder {
...
@implementation JunctoMeetConferenceOptions {
...
- (instancetype)initWithBuilder:(JunctoMeetConferenceOptionsBuilder *)builder {
    if (self = [super init]) {
...
+ (instancetype)fromBuilder:(void (^)(JunctoMeetConferenceOptionsBuilder *))initBlock {
    JunctoMeetConferenceOptionsBuilder *builder = [[JunctoMeetConferenceOptionsBuilder alloc] init];
    initBlock(builder);
    return [[JunctoMeetConferenceOptions alloc] initWithBuilder:builder];
}
