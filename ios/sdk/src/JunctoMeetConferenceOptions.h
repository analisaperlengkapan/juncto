...
#import "JunctoMeetUserInfo.h"


@interface JunctoMeetConferenceOptionsBuilder : NSObject
 ...
 */
@property (nonatomic, nullable) JunctoMeetUserInfo *userInfo;
...
@interface JunctoMeetConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(JunctoMeetConferenceOptionsBuilder *_Nonnull))initBlock;
