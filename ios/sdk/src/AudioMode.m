...
#import "JunctoAudioSession+Private.h"
...
// Events
static NSString * const kDevicesChanged = @"org.juncto.meet:features/audio-mode#devices-update";
...
@implementation AudioMode {
    JunctoMeetAudioMode activeMode;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        RTCAudioSession *session = JunctoAudioSession.rtcAudioSession;
