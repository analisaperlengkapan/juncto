...
echo "Releasing Juncto SDK Lite ${SDK_VERSION}"

pushd ${RELEASE_REPO}

# Generate podspec file
cat JunctoMeetSDKLite.podspec.tpl | sed -e s/VERSION/${SDK_VERSION}-lite/g > JunctoMeetSDKLite.podspec
...
cp -a ${PROJECT_REPO}/ios/sdk/out/JunctoMeetSDK.xcframework lite/Frameworks/
...
echo "The new pod can be pushed to CocoaPods by doing: pod trunk push JunctoMeetSDKLite.podspec"
