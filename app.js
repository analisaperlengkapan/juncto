...
// We need to setup the juncto-local-storage as early as possible so that we can start using it.
// NOTE: If juncto-local-storage is used before the initial setup is performed this will break the use case when we use
...
import './react/features/base/juncto-local-storage/setup';
