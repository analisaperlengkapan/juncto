 ...
 *
 * @param {JunctoParticipant} user - The user which status we need to update.
...
UI.updateUserStatus = (user, status) => {
    ...
    // as jungasi is the component with statuses and they are seen as join/leave notifications.
