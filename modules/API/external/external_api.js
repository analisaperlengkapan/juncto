import { junctoLocalStorage } from '@juncto/js-utils/juncto-local-storage';
 ...
 *
 * @param {JunctoMeetExternalAPI} APIInstance - The instance of the API.
 ...
 */
export default class JunctoMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Juncto in it.
     *
     ...
     * @param {string} [options.jwt] - The JWT token if needed by juncto for
     * authentication.
    ...
    constructor(domain, options = {}) {
        ...
        const localStorageContent = junctoLocalStorage.getItem('junctoLocalStorage');
        ...
        this._url = urlObjectToString({
            ...
            release,
            url: `https://${domain}/#juncto_meet_external_api_id=${id}`
        });
        ...
        this._transport = new Transport({
            backend: new PostMessageTransportBackend({
                postisOptions: {
                    ...
                    scope: `juncto_meet_external_api_${id}`,
    ...
    _createIFrame(height, width, sandbox) {
        const frameName = `junctoConferenceFrame${id}`;
    ...
    /**
     * Getter for the large video element in Juncto.
     *
    ...
    /**
     * Getter for the prejoin video element in Juncto.
     *
    ...
    /**
     * Getter for participant specific video element in Juncto.
     *
    ...
    /**
     * Setups listeners that are used internally for JunctoMeetExternalAPI.
     *
     * @returns {void}
     *
     * @private
    ...
    _setupListeners() {
        this._transport.on('event', ({ name, ...data }) => {
            ...
            case 'local-storage-changed':
                junctoLocalStorage.setItem('junctoLocalStorage', data.localStorageContent);
    ...
    /**
     * Adds event listener to Meet Juncto.
     *
    ...
    /**
     * Adds event listeners to Meet Juncto.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Juncto
    ...
    /**
     * Removes the listeners and removes the Juncto frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Juncto.
     *
