...
import org.juncto.meet.sdk.JunctoMeetConferenceOptions;
...
public class MainActivity extends JunctoMeetActivity {
    ...
    // JunctoMeetActivity overrides
    //

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        JunctoMeet.showSplashScreen(this);
    ...
    protected boolean extraInitialize() {
        ...
        try {
            Class<?> cls = Class.forName("org.juncto.meet.GoogleServicesHelper");
            Method m = cls.getMethod("initialize", JunctoMeetActivity.class);
            m.invoke(null, this);
        } catch (Exception e) {
    ...
    protected void initialize() {
        ...
        resolveRestrictions();
        setJunctoMeetConferenceDefaultOptions();
        super.initialize();
    }
    ...
    private void setJunctoMeetConferenceDefaultOptions() {

        // Set default options
        JunctoMeetConferenceOptions defaultOptions
            = new JunctoMeetConferenceOptions.Builder()
            .setServerURL(buildURL(defaultURL))
            .setFeatureFlag("welcomepage.enabled", true)
            .setFeatureFlag("server-url-change.enabled", !configurationByRestrictions)
            .build();
        JunctoMeet.setDefaultConferenceOptions(defaultOptions);
    }
