...
public class JunctoMeetView extends FrameLayout {
    ...
    public JunctoMeetView(@NonNull Context context) {
        super(context);
        initialize(context);
    }

    public JunctoMeetView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(context);
    }

    public JunctoMeetView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void enterPictureInPicture() {
        ...
        if (pipModule != null
                ...
                && !JunctoMeetActivityDelegate.arePermissionsBeingRequested()) {
            try {
                pipModule.enterPictureInPicture();
            } catch (RuntimeException re) {
                JunctoMeetLogger.e(re, "Failed to enter PiP mode");
            }
        }
    }

    /**
     * Joins the conference specified by the given {@link JunctoMeetConferenceOptions}. If there is
     ...
     *                when doing so.
     */
    public void join(@Nullable JunctoMeetConferenceOptions options) {
    ...
    private void initialize(@NonNull Context context) {
        // Check if the parent Activity implements JunctoMeetActivityInterface,
        // otherwise things may go wrong.
        if (!(context instanceof JunctoMeetActivityInterface)) {
            throw new RuntimeException("Enclosing Activity must implement JunctoMeetActivityInterface");
        }
    ...
    private void setProps(@NonNull Bundle newProps) {
        ...
        Bundle props = mergeProps(JunctoMeet.getDefaultProps(), newProps);
