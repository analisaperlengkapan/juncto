...
import org.webrtc.JunctoPlatformVideoDecoderFactory;
 ...
 */
public class JunctoVideoDecoderFactory implements VideoDecoderFactory {
     ...
     */
    public JunctoVideoDecoderFactory(@Nullable EglBase.Context eglContext) {
        this.hardwareVideoDecoderFactory = new HardwareVideoDecoderFactory(eglContext, hwCodecPredicate);
        this.platformSoftwareVideoDecoderFactory = new JunctoPlatformVideoDecoderFactory(eglContext, swCodecPredicate);
    }
