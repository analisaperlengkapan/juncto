...
/**
 * Defines the default behavior of {@code JunctoMeetFragment} and
 * {@code JunctoMeetView} upon invoking the back button if no
 * {@code JunctoMeetView} handles the invocation. For example, a
 * {@code JunctoMeetView} may (1) handle the invocation of the back button
