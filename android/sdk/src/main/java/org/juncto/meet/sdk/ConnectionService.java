...
/**
 * Juncto implementation of {@link ConnectionService}. At the time of this
...
public class ConnectionService extends android.telecom.ConnectionService {
     ...
     */
    static final String TAG = "JunctoConnectionService";
    ...
    static final String EXTRA_PHONE_ACCOUNT_HANDLE
        = "org.juncto.meet.sdk.connection_service.PHONE_ACCOUNT_HANDLE";
    ...
    static boolean setConnectionActive(String callUUID) {
        ...
        if (connection != null) {
            ...
            JunctoMeetLogger.w("%s setConnectionActive - no connection for UUID: %s", TAG, callUUID);
            return false;
        }
    }
    ...
    static void setConnectionDisconnected(String callUUID, DisconnectCause cause) {
        ...
        if (connection != null) {
            ...
            JunctoMeetLogger.e(TAG + " endCall no connection for UUID: " + callUUID);
        }
    }
    ...
    static void updateCall(String callUUID, ReadableMap callState) {
        ...
        if (connection != null) {
            if (callState.hasKey(ConnectionImpl.KEY_HAS_VIDEO)) {
                ...
                JunctoMeetLogger.i(" %s updateCall: %s hasVideo: %s", TAG, callUUID, hasVideo);
            ...
            JunctoMeetLogger.e(TAG + " updateCall no connection for UUID: " + callUUID);
        }
    }
    ...
    public Connection onCreateOutgoingConnection(
        ...
        if (startCallPromise != null) {
            JunctoMeetLogger.d(TAG + " onCreateOutgoingConnection " + connection.getCallUUID());
    ...
    public void onCreateOutgoingConnectionFailed(
        ...
        JunctoMeetLogger.e(TAG + " onCreateOutgoingConnectionFailed " + callUUID);
        ...
        if (callUUID != null) {
            ...
            if (startCallPromise != null) {
                ...
                JunctoMeetLogger.e(TAG + " startCallFailed - no start call Promise for UUID: " + callUUID);
            }
        } else {
            JunctoMeetLogger.e(TAG + " onCreateOutgoingConnectionFailed - no call UUID");
        }
    ...
    private void unregisterPhoneAccount(PhoneAccountHandle phoneAccountHandle) {
        ...
        if (telecom != null) {
            if (phoneAccountHandle != null) {
                ...
                JunctoMeetLogger.e(TAG + " unregisterPhoneAccount - account handle is null");
            }
        } else {
            JunctoMeetLogger.e(TAG + " unregisterPhoneAccount - telecom is null");
        }
    }
    ...
    /**
     * Connection implementation for Juncto's {@link ConnectionService}.
     *
     * @author Pawel Domas
     */
    class ConnectionImpl extends Connection {
        ...
        public void onDisconnect() {
            JunctoMeetLogger.i(TAG + " onDisconnect " + getCallUUID());
            WritableNativeMap data = new WritableNativeMap();
            data.putString("callUUID", getCallUUID());
            RNConnectionService.getInstance().emitEvent(
                    "org.juncto.meet:features/connection_service#disconnect",
                    data);
        ...
        @Override
        public void onAbort() {
            JunctoMeetLogger.i(TAG + " onAbort " + getCallUUID());
            WritableNativeMap data = new WritableNativeMap();
            data.putString("callUUID", getCallUUID());
            RNConnectionService.getInstance().emitEvent(
                    "org.juncto.meet:features/connection_service#abort",
                    data);
            // The JavaScript side will not go back to the native with
            // 'endCall', so the Connection must be removed immediately.
            setConnectionDisconnected(
        ...
        public void onHold() {
            ...
            // TODO implement HOLD
            JunctoMeetLogger.w(TAG + " onHold %s - HOLD is not supported, aborting the call...", getCallUUID());
            this.onAbort();
        }
        ...
        public void onCallAudioStateChanged(CallAudioState state) {
            JunctoMeetLogger.d(TAG + " onCallAudioStateChanged: " + state);
