 ...
 * {@link JunctoMeetOngoingConferenceService}. It allows the user to easily get back to the app
...
class OngoingNotification {
    ...
    static final String ONGOING_CONFERENCE_CHANNEL_ID = "JunctoOngoingConferenceChannel";

    static void createNotificationChannel(Activity context) {
        if (context == null) {
            JunctoMeetLogger.w(TAG + " Cannot create notification channel: no current context");
            return;
        }
    ...
    static Notification buildOngoingConferenceNotification(Boolean isMuted, Context context, Class tapBackActivity) {
        if (context == null) {
            JunctoMeetLogger.w(TAG + " Cannot create notification: no current context");
            return null;
        }
        ...
        NotificationCompat.Action hangupAction = createAction(context, JunctoMeetOngoingConferenceService.Action.HANGUP, R.string.ongoing_notification_action_hang_up);

        JunctoMeetOngoingConferenceService.Action toggleAudioAction = isMuted
            ? JunctoMeetOngoingConferenceService.Action.UNMUTE : JunctoMeetOngoingConferenceService.Action.MUTE;
    ...
    private static NotificationCompat.Action createAction(Context context, JunctoMeetOngoingConferenceService.Action action, @StringRes int titleId) {
