...
public class JunctoMeet {

    /**
     * Default {@link JunctoMeetConferenceOptions} which will be used for all conferences. When
     * joining a conference these options will be merged with the ones passed to
     * {@link JunctoMeetView} join().
     */
    private static JunctoMeetConferenceOptions defaultConferenceOptions;

    public static JunctoMeetConferenceOptions getDefaultConferenceOptions() {
        return defaultConferenceOptions;
    }

    public static void setDefaultConferenceOptions(JunctoMeetConferenceOptions options) {
    ...
    public static boolean isCrashReportingDisabled(Context context) {
        SharedPreferences preferences = context.getSharedPreferences("juncto-default-preferences", Context.MODE_PRIVATE);
    ...
    public static void showSplashScreen(Activity activity) {
        try {
            ...
            JunctoMeetLogger.e(e, "Failed to show splash screen");
        }
    }
}