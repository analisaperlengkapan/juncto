/*
 * Copyright @ 2018-present Juncto Pty Ltd
 *
 ...
 */
package org.juncto.meet.sdk.net;
    ...
    public void getIPv6Address(String ipv4Address, final Promise promise) {
        ...
        if (info == null) {
            ...
            try {
                ...
                JunctoMeetLogger.e(e, TAG + " NAT64AddrInfo.discover: " + host);
            }
        ...
        try {
            ...
            JunctoMeetLogger.e(exc, TAG + " Failed to get IPv6 address for: " + ipv4Address);
