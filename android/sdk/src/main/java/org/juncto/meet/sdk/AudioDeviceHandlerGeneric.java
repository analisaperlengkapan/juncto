...
class AudioDeviceHandlerGeneric implements
    ...
    private final Runnable onAudioDeviceChangeRunner = new Runnable() {
        ...
        public void run() {
            ...
            JunctoMeetLogger.i(TAG + " Available audio devices: " + devices.toString());
    ...
    private final android.media.AudioDeviceCallback audioDeviceCallback =
        new android.media.AudioDeviceCallback() {
            ...
            public void onAudioDevicesAdded(
                ...
                JunctoMeetLogger.d(TAG + " Audio devices added");
                onAudioDeviceChange();
            }
            ...
            public void onAudioDevicesRemoved(
                ...
                JunctoMeetLogger.d(TAG + " Audio devices removed");
                onAudioDeviceChange();
            }
        };
            ...
            public void run() {
                switch (focusChange) {
                    case AudioManager.AUDIOFOCUS_GAIN: {
                        JunctoMeetLogger.d(TAG + " Audio focus gained");
                    ...
                    case AudioManager.AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK: {
                        JunctoMeetLogger.d(TAG + " Audio focus lost");
                        audioFocusLost = true;
                        break;
                    }
                }
    ...
    public void start(AudioModeModule audioModeModule) {
        JunctoMeetLogger.i("Using " + TAG + " as the audio device handler");
    ...
    public boolean setMode(int mode) {
        ...
        if (gotFocus == AudioManager.AUDIOFOCUS_REQUEST_FAILED) {
            JunctoMeetLogger.w(TAG + " Audio focus request failed");
            return false;
        }
