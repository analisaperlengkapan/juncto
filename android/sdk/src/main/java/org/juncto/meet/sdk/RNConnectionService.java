...
/**
 * The react-native side of Juncto's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Juncto to
     *        a conference call.
     * @param handle - a call handle which by default is Juncto room's URL.
    ...
    public void startCall(
            ...
            boolean hasVideo,
            Promise promise) {
        JunctoMeetLogger.d("%s startCall UUID=%s, h=%s, v=%s",
                            TAG,
                            callUUID,
                            handle,
                            hasVideo);
        ...
        try {
            ...
            JunctoMeetLogger.e(tr, TAG + " error in startCall");
    ...
    public void reportCallFailed(String callUUID) {
        JunctoMeetLogger.d(TAG + " reportCallFailed " + callUUID);
    ...
    public void endCall(String callUUID) {
        JunctoMeetLogger.d(TAG + " endCall " + callUUID);
        ConnectionService.setConnectionDisconnected(
                callUUID,
    ...
    public void reportConnectedOutgoingCall(String callUUID, Promise promise) {
        JunctoMeetLogger.d(TAG + " reportConnectedOutgoingCall " + callUUID);
