...
/**
 * This class represents the options when joining a Juncto conference. The user can create an
 * instance by using {@link JunctoMeetConferenceOptions.Builder} and setting the desired options
 * there.
 *
 * The resulting {@link JunctoMeetConferenceOptions} object is immutable and represents how the
 * conference will be joined.
 */
public class JunctoMeetConferenceOptions implements Parcelable {
    /**
    ...
    /**
     * Config. See: https://github.com/juncto/juncto/blob/master/config.js
     */
    private Bundle config;

    /**
     * Feature flags. See: https://github.com/juncto/juncto/blob/master/react/features/base/flags/constants.js
     */
     ...
     */
    private JunctoMeetUserInfo userInfo;
    ...
    public JunctoMeetUserInfo getUserInfo() {
        return userInfo;
    }

    /**
     * Class used to build the immutable {@link JunctoMeetConferenceOptions} object.
     */
    public static class Builder {
        ...
        public Builder setUserInfo(JunctoMeetUserInfo userInfo) {
        ...
        /**
         * Builds the immutable {@link JunctoMeetConferenceOptions} object with the configuration
         * that this {@link Builder} instance specified.
         * @return - The built {@link JunctoMeetConferenceOptions} object.
         */
        public JunctoMeetConferenceOptions build() {
            JunctoMeetConferenceOptions options = new JunctoMeetConferenceOptions();
    ...
    private JunctoMeetConferenceOptions() {
    }

    private JunctoMeetConferenceOptions(Parcel in) {
        serverURL = (URL) in.readSerializable();
        room = in.readString();
        token = in.readString();
        config = in.readBundle();
        featureFlags = in.readBundle();
        userInfo = new JunctoMeetUserInfo(in.readBundle());
    }
    ...
    public static final Creator<JunctoMeetConferenceOptions> CREATOR = new Creator<JunctoMeetConferenceOptions>() {
        @Override
        public JunctoMeetConferenceOptions createFromParcel(Parcel in) {
            return new JunctoMeetConferenceOptions(in);
        }

        @Override
        public JunctoMeetConferenceOptions[] newArray(int size) {
            return new JunctoMeetConferenceOptions[size];
        }
    };
