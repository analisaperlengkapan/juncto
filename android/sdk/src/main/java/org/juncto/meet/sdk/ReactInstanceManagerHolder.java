...
class ReactInstanceManagerHolder {
    ...
    private static List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
        List<NativeModule> nativeModules
            = new ArrayList<>(Arrays.<NativeModule>asList(
                ...
                new org.juncto.meet.sdk.net.NAT64AddrInfoModule(reactContext)));
    ...
    static List<ReactPackage> getReactNativePackages() {
        ...
        try {
            ...
            JunctoMeetLogger.d(TAG, "Not loading AmplitudeReactNativePackage");
        }
        ...
        try {
            ...
            // Ignore any error, the module is not compiled when LIBRE_BUILD is enabled.
            JunctoMeetLogger.d(TAG, "Not loading GiphyReactNativeSdkPackage");
        }
        ...
        try {
            ...
            // Ignore any error, the module is not compiled when LIBRE_BUILD is enabled.
            JunctoMeetLogger.d(TAG, "Not loading RNGoogleSignInPackage");
        }
    ...
    static void initReactInstanceManager(Application app) {
        ...
        if (options.videoDecoderFactory == null || options.videoEncoderFactory == null) {
            ...
            if (options.videoDecoderFactory == null) {
                options.videoDecoderFactory = new JunctoVideoDecoderFactory(eglContext);
            }
            if (options.videoEncoderFactory == null) {
                options.videoEncoderFactory = new JunctoVideoEncoderFactory(eglContext);
            }
        }

        JunctoMeetLogger.d(TAG, "initializing RN");
