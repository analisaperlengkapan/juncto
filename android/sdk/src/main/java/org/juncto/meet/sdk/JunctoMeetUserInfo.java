...
/**
 * This class represents user information to be passed to {@link JunctoMeetConferenceOptions} for
 * identifying a user.
 */
public class JunctoMeetUserInfo {
    /**
     * User's display name.
     */
    ...
    public JunctoMeetUserInfo() {}

    public JunctoMeetUserInfo(Bundle b) {
        super();
