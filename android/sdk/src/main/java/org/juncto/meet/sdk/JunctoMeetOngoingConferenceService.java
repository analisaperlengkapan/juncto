 ...
 */
public class JunctoMeetOngoingConferenceService extends Service implements OngoingConferenceTracker.OngoingConferenceListener {
    private static final String TAG = JunctoMeetOngoingConferenceService.class.getSimpleName();
    ...
    private static void doLaunch(Context context, HashMap<String, Object> extraData) {
        ...
        Intent intent = new Intent(context, JunctoMeetOngoingConferenceService.class);
        ...
        try {
            ...
            JunctoMeetLogger.w(TAG + " Ongoing conference service not started", e);
            return;
        }

        if (componentName == null) {
            JunctoMeetLogger.w(TAG + " Ongoing conference service not started");
        }
    }
    ...
    public static void launch(Context context, HashMap<String, Object> extraData) {
            ...
            public boolean onRequestPermissionsResult(int i, String[] strings, int[] results) {
                ...
                if (results.length > 0) {
                    ...
                    if (counter == results.length){
                        ...
                        JunctoMeetLogger.w(TAG + " Service launched, permissions were granted");
                    } else {
                        JunctoMeetLogger.w(TAG + " Couldn't launch service, permissions were not granted");
                    }
                }
        ...
        if (permissionsArray.length > 0) {
            JunctoMeetActivityDelegate.requestPermissions(
                activity,
                permissionsArray,
            ...
            doLaunch(context, extraData);
            JunctoMeetLogger.w(TAG + " Service launched");
        }
    }
    ...
    public void onCreate() {
        ...
        if (notification == null) {
            stopSelf();
            JunctoMeetLogger.w(TAG + " Couldn't start service, notification is null");
        } else {
            try {
                ...
                JunctoMeetLogger.w(TAG + " Failed to start foreground service", e);
                stopSelf();
                return;
            }
        }
        ...
        if (action != Action.HANGUP) {
            ...
            if (tapBackActivity == null) {
                ...
                try {
                    ...
                    JunctoMeetLogger.w(TAG + " Could not find target Activity: " + targetActivityName);
                }
            }
        ...
        if (action != null) {
            switch (action) {
                ...
                case MUTE:
                    ...
                    break;
                case HANGUP:
                    JunctoMeetLogger.i(TAG + " Hangup requested");
                    ...
                    break;
                default:
                    JunctoMeetLogger.w(TAG + " Unknown action received: " + action);
                    break;
            }
        }
    ...
    public void onCurrentConferenceChanged(String conferenceUrl) {
        if (conferenceUrl == null) {
            ...
            JunctoMeetLogger.i(TAG + "Service stopped");
        }
    }
    ...
    private class BroadcastReceiver extends android.content.BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Class tapBackActivity = JunctoMeetOngoingConferenceService.this.tapBackActivity;
            ...
            if (notification == null) {
                stopSelf();
                JunctoMeetLogger.w(TAG + " Couldn't update service, notification is null");
            } else {
                NotificationManager notificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
                notificationManager.notify(NOTIFICATION_ID, notification);

                JunctoMeetLogger.i(TAG + " audio muted changed");
            }
        }
    }
}
