...
public class BroadcastEvent {
        ...
        if (type != null && type.action != null) {
            ...
            for (String key : this.data.keySet()) {
                try {
                    ...
                    JunctoMeetLogger.w(TAG + " invalid extra data in event", e);
                }
            }
    ...
    private static HashMap<String, Object> buildDataFromBundle(Bundle bundle) {
        if (bundle != null) {
            try {
                ...
                JunctoMeetLogger.w(TAG + " invalid extra data", e);
            }
        }
    ...
    public enum Type {
        CONFERENCE_BLURRED("org.juncto.meet.CONFERENCE_BLURRED"),
        CONFERENCE_FOCUSED("org.juncto.meet.CONFERENCE_FOCUSED"),
        CONFERENCE_JOINED("org.juncto.meet.CONFERENCE_JOINED"),
        CONFERENCE_TERMINATED("org.juncto.meet.CONFERENCE_TERMINATED"),
        CONFERENCE_WILL_JOIN("org.juncto.meet.CONFERENCE_WILL_JOIN"),
        AUDIO_MUTED_CHANGED("org.juncto.meet.AUDIO_MUTED_CHANGED"),
        PARTICIPANT_JOINED("org.juncto.meet.PARTICIPANT_JOINED"),
        PARTICIPANT_LEFT("org.juncto.meet.PARTICIPANT_LEFT"),
        ENDPOINT_TEXT_MESSAGE_RECEIVED("org.juncto.meet.ENDPOINT_TEXT_MESSAGE_RECEIVED"),
        SCREEN_SHARE_TOGGLED("org.juncto.meet.SCREEN_SHARE_TOGGLED"),
        PARTICIPANTS_INFO_RETRIEVED("org.juncto.meet.PARTICIPANTS_INFO_RETRIEVED"),
        CHAT_MESSAGE_RECEIVED("org.juncto.meet.CHAT_MESSAGE_RECEIVED"),
        CHAT_TOGGLED("org.juncto.meet.CHAT_TOGGLED"),
        VIDEO_MUTED_CHANGED("org.juncto.meet.VIDEO_MUTED_CHANGED"),
        READY_TO_CLOSE("org.juncto.meet.READY_TO_CLOSE"),
        TRANSCRIPTION_CHUNK_RECEIVED("org.juncto.meet.TRANSCRIPTION_CHUNK_RECEIVED"),
        CUSTOM_BUTTON_PRESSED("org.juncto.meet.CUSTOM_BUTTON_PRESSED"),
        CONFERENCE_UNIQUE_ID_SET("org.juncto.meet.CONFERENCE_UNIQUE_ID_SET"),
        RECORDING_STATUS_CHANGED("org.juncto.meet.RECORDING_STATUS_CHANGED");
