...
public class JunctoPlatformVideoDecoderFactory extends MediaCodecVideoDecoderFactory {
    /**
     ...
     */
    public JunctoPlatformVideoDecoderFactory(@Nullable EglBase.Context sharedContext) {
        super(sharedContext, defaultAllowedPredicate);
    }

    public JunctoPlatformVideoDecoderFactory(@Nullable EglBase.Context sharedContext, @Nullable Predicate<MediaCodecInfo> codecAllowedPredicate) {
