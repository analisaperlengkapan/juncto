 ...
 * If the user checks this before closing the banner, next time he will access a juncto domain
...
class ChromeExtensionBanner extends PureComponent<IProps, IState> {
    ...
    _shouldNotRender() {
        ...
        const dontShowAgain = junctoLocalStorage.getItem(DONT_SHOW_AGAIN_CHECKED) === 'true';
    ...
    override render(): React.ReactNode {
        if (this._shouldNotRender()) {
            if (this.state.dontShowAgainChecked) {
                junctoLocalStorage.setItem(DONT_SHOW_AGAIN_CHECKED, 'true');
            }
