...
StateListenerRegistry.register(
    ...
    (conference, { dispatch }, previousConference) => {
        ...
        if (conference) {
            conference.on(JunctoConferenceEvents.E2EE_VERIFICATION_AVAILABLE, (pId: string) => {
                dispatch(participantUpdated({
            ...
            conference.on(JunctoConferenceEvents.E2EE_VERIFICATION_READY, (pId: string, sas: object) => {
                dispatch(openDialog('ParticipantVerificationDialog', ParticipantVerificationDialog, { pId,
                    sas }));
            });

            conference.on(JunctoConferenceEvents.E2EE_VERIFICATION_COMPLETED,
