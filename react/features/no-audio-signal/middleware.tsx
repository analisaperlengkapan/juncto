...
import JunctoMeetJS, { JunctoConferenceEvents } from '../base/lib-juncto';
...
async function _handleNoAudioSignalNotification({ dispatch, getState }: IStore, action: AnyAction) {
    ...
    conference.on(JunctoConferenceEvents.AUDIO_INPUT_STATE_CHANGE, (hasAudioInput: boolean) => {
    ...
    conference.on(JunctoConferenceEvents.NO_AUDIO_INPUT, async () => {
        ...
        const activeDevice = await JunctoMeetJS.getActiveAudioDevice();
