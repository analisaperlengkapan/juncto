...
import JunctoStreamBackgroundEffect, { IBackgroundEffectOptions } from './JunctoStreamBackgroundEffect';
// @ts-ignore
...
/**
 * Creates a new instance of JunctoStreamBackgroundEffect. This loads the Meet background model that is used to
 * extract person segmentation.
 *
 * @param {Object} virtualBackground - The virtual object that contains the background image source and
 * the isVirtualBackground flag that indicates if virtual image is activated.
 * @param {Function} dispatch - The Redux dispatch function.
 * @returns {Promise<JunctoStreamBackgroundEffect>}
 */
export async function createVirtualBackgroundEffect(virtualBackground: IBackgroundEffectOptions['virtualBackground'],
    ...
    if (!MediaStreamTrack.prototype.getSettings && !MediaStreamTrack.prototype.getConstraints) {
        throw new Error('JunctoStreamBackgroundEffect not supported!');
    }
    ...
    return new JunctoStreamBackgroundEffect(tflite, options);
}
