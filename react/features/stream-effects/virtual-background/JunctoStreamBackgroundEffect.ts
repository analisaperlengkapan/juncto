 ...
 * <tt>JunctoStreamBackgroundEffect</tt> does the processing of the original
 * video stream.
 */
export default class JunctoStreamBackgroundEffect {
    _model: any;
     ...
     *
     * @param {JunctoLocalTrack} junctoLocalTrack - Track to apply effect.
     * @returns {boolean} - Returns true if this effect can run on the specified track
     * false otherwise.
     */
    isEnabled(junctoLocalTrack: any) {
        return junctoLocalTrack.isVideoTrack() && junctoLocalTrack.videoType === 'camera';
    }
