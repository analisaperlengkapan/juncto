 ...
 * Effect applies rnnoise denoising on a audio JunctoLocalTrack.
 */
export class NoiseSuppressionEffect {
    ...
    /**
     * Effect interface called by source JunctoLocalTrack.
    ...
    isEnabled(sourceLocalTrack: any): boolean {
        // JunctoLocalTracks needs to be an audio track.
