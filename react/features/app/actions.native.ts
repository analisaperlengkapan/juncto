...
import { JUNCTO_CONNECTION_URL_KEY } from '../base/connection/constants';
import { loadConfig } from '../base/lib-juncto/functions.native';
    ...
    return async (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        if (room) {
            if (conference) {
                ...
                const currentLocationURL = conference?.getConnection()[JUNCTO_CONNECTION_URL_KEY];
