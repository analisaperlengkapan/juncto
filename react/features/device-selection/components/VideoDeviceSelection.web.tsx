...
import { createLocalTrack } from '../../base/lib-juncto/functions.web';
...
interface IState {
    ...
    /**
     * The JunctoTrack to use for previewing video input.
     */
...
class VideoDeviceSelection extends AbstractDialogTab<IProps, IState> {
    ...
    /**
     * Creates the JunctoTrack for the video input preview.
     *
    ...
    _createVideoInputTrack(deviceId: string) {
        ...
        return this._disposeVideoInputPreview()
            ...
            .then(junctoLocalTrack => {
                if (!junctoLocalTrack) {
                    return Promise.reject();
                }

                if (this._unMounted) {
                    junctoLocalTrack.dispose();

                    return;
                }

                this.setState({
                    previewVideoTrack: junctoLocalTrack,
                    previewVideoTrackError: null
                });
            })
            .catch(() => {
