 ...
 * @param {JunctoConference} conference - The conference for which the local
 ...
 * specified error. Refer to {@link JunctoConference#authenticateAndUpgradeRole}
 * in lib-juncto for the error details.
 * @private
 * @returns {{
...
/**
 * Called when Juncofo rejects to create the room for anonymous user. Will
