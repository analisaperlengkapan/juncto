...
const VideoSettingsContent = ({
     ...
     */
    const _disposeTracks = (tracks: { junctoTrack: any; }[]) => {
    ...
    const _renderPreviewEntry = (data: { deviceId: string; error?: string; junctoTrack: any | null; },
            index: number) => {
        const { error, junctoTrack, deviceId } = data;
        ...
        const label = junctoTrack?.getTrackLabel();
