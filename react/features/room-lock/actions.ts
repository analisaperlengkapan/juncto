 ...
 *
 * @param {JunctoConference} conference - The {@code JunctoConference} requesting
...
export function _cancelPasswordRequiredPrompt(conference: any) {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        if (conference === state['features/base/conference'].passwordRequired
                && conference[JUNCTO_CONFERENCE_URL_KEY]
 ...
 *
 * @param {JunctoConference} conference - The JunctoConference to lock.
 ...
 *
 * @param {JunctoConference} conference - The {@code JunctoConference}
 ...
 * }}
 */
export function _openPasswordRequiredPrompt(conference: IJunctoConference) {
    return openDialog('PasswordRequiredPrompt', PasswordRequiredPrompt, { conference });
}

/**
 * Unlocks the current juncto conference.
 *
 * @returns {Function}
 */
