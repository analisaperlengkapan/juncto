...
export function requestRemoteControl(userId: string) {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        conference?.on(JunctoConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, permissionsReplyListener);
    ...
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        if (isRemoteControlEnabled(state) && name === REMOTE_CONTROL_MESSAGE_NAME && type === EVENTS.permissions
            ...
            case PERMISSIONS_ACTIONS.grant: {
                ...
                conference?.on(JunctoConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, stopListener);
...
export function stopController(notifyRemoteParty = false) {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        conference?.off(JunctoConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, stopListener);
...
export function clearRequest() {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        conference?.off(JunctoConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, permissionsReplyListener);
...
export function enableReceiver() {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        conference.on(JunctoConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, receiverEndpointMessageListener);
    };
}
...
export function disableReceiver() {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        conference.off(JunctoConferenceEvents.ENDPOINT_MESSAGE_RECEIVED, receiverEndpointMessageListener);
    };
}
...
export function sendStartRequest() {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        const { sourceId } = track?.junctoTrack || {};
...
export function grant(participantId: string) {
    return (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        const { sourceType } = track?.junctoTrack || {};
