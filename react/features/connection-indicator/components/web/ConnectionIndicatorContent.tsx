...
export function _mapStateToProps(state: IReduxState, ownProps: any) {
    ...
    return {
        _audioSsrc: audioTrack ? conference?.getSsrcByTrack(audioTrack.junctoTrack) : undefined,
        ...
        _videoSsrc: videoTrack ? conference?.getSsrcByTrack(videoTrack.junctoTrack) : undefined
    };
}
