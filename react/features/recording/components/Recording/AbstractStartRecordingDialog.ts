...
export interface IProps extends WithTranslation {
    ...
    /**
     * The {@code JunctoConference} for the current conference.
     */
...
class AbstractStartRecordingDialog extends Component<IProps, IState> {
    ...
    constructor(props: IProps) {
        ...
        if (this.props._fileRecordingsServiceEnabled
            ...
            selectedRecordingService = RECORDING_TYPES.JUNCTO_REC_SERVICE;
    ...
    _onSubmit() {
        ...
        if (this.state.shouldRecordAudioAndVideo) {
            ...
            case RECORDING_TYPES.JUNCTO_REC_SERVICE: {
                appData = JSON.stringify({
                    'file_recording_metadata': {
                        'share': this.state.sharingEnabled
                    }
                });
                attributes.type = RECORDING_TYPES.JUNCTO_REC_SERVICE;
                break;
            }
        ...
        if (this.state.selectedRecordingService === RECORDING_TYPES.JUNCTO_REC_SERVICE
