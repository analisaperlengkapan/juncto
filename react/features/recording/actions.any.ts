...
import JunctoMeetJS, { JunctoRecordingConstants } from '../base/lib-juncto';
...
export function showPendingRecordingNotification(streamType: string) {
    return (dispatch: IStore['dispatch']) => {
        const isLiveStreaming
            = streamType === JunctoMeetJS.constants.recording.mode.STREAM;
...
export function showStartedRecordingNotification(
    ...
    return async (dispatch: IStore['dispatch'], getState: IStore['getState']) => {
        ...
        if (mode !== JunctoMeetJS.constants.recording.mode.STREAM) {
