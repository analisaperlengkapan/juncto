...
/**
 * Sends feedback metadata to JunctoService endpoints.
 *
 * @param {string|undefined} url - The JunctoService metadata endpoint URL.
 * @param {Object} feedbackData - The feedback data object.
 * @returns {Promise}
 */
export async function sendFeedbackToJunctoServiceRequest(url: string | undefined, feedbackData: {
 ...
 */
export function shouldSendJunctoServiceFeedbackMetadata(state: IReduxState) {
