...
/**
 * A component that renders the description of the notification for old Juncto Electron clients.
 *
    ...
    override render() {
        ...
        return (
            <div>
                ...
                <a
                    href = 'https://github.com/juncto/juncto-electron/releases/latest'
