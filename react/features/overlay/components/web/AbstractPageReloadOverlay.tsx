// @ts-expect-error
import { randomInt } from '@juncto/js-utils/random';
...
} from '../../../base/lib-juncto/functions.web';
...
export default class AbstractPageReloadOverlay<P extends IProps>
    ...
    static needsRender(state: IReduxState) {
        ...
        const junctoConnectionError
            = connectionError && isFatalJunctoConnectionError(connectionError);
        const junctoConferenceError
            = conferenceError && isFatalJunctoConferenceError(conferenceError);

        return junctoConnectionError || junctoConferenceError || configError;
    }
