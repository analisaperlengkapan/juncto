...
interface IProps {
    ...
    /**
     * The JunctoConference's connection state. It's the lib-juncto's event
...
/**
 * The component will expose some of the app state to the juncto-torture
...
class TestConnectionInfo extends Component<IProps, State> {
     ...
     * the lib-juncto for more details on the actual structure or add
    ...
    override render() {
        ...
        return (
            <Fragment>
                <TestHint
                    id = 'org.juncto.meet.conference.connectionState'
                    value = { this.props._conferenceConnectionState } />
                <TestHint
                    id = 'org.juncto.meet.conference.joinedState'
                    value = { this.props._conferenceJoinedState } />
                <TestHint
                    id = 'org.juncto.meet.conference.grantModeratorAvailable'
                    value = { 'true' } />
                <TestHint
                    id = 'org.juncto.meet.conference.localParticipantRole'
                    value = { this.props._localUserRole } />
                <TestHint
                    id = 'org.juncto.meet.stats.rtp'
