 ...
 *
 * @param {string} connectionState - This is the lib-juncto event name. Can
 * be one of (with the string values at the time of this writing):
 * <li>{@link JunctoConferenceEvents.CONNECTION_ESTABLISHED}
 * - ("conference.connectionEstablished"</li>
 * <li>{@link JunctoConferenceEvents.CONNECTION_INTERRUPTED}
 * - ("conference.connectionInterrupted")</li>
 * <li>{@link JunctoConferenceEvents.CONNECTION_RESTORED}
