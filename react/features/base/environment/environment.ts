...
const { browser } = JunctoMeetJS.util;
...
/**
 * Returns whether or not juncto is optimized and targeted for the  provided
 * browser name.
 *
...
export function isSupportedBrowser() {
    ...
    return isMobileBrowser() ? isSupportedMobileBrowser() : JunctoMeetJS.isWebRtcSupported();
}
