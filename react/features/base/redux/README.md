Juncto - redux state persistence
====================================
Juncto has a persistence layer that persists specific subtrees of the redux
...
When it's done, Juncto will automatically persist these subtrees and
