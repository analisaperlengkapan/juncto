...
import JunctoKeyboardAvoidingView from './JunctoKeyboardAvoidingView';
...
const JunctoScreen = ({
    ...
    return (
        <View style = { styles.junctoScreenContainer }>
            { renderContent() }
        </View>
    );
};
