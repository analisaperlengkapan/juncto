 ...
 * @property {JunctoLocalTrack|JunctoRemoteTrack} junctoTrack - The associated
 * {@code JunctoTrack} instance. Optional for local tracks if those are still
 ...
 * it will have no {@code JunctoTrack}, but a {@code gumProcess} set to a
