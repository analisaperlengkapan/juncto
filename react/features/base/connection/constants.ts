/**
 * The name of the {@code JunctoConnection} property which identifies the {@code JunctoConference} currently associated
 * with it.
 *
 ...
 */
export const JUNCTO_CONNECTION_CONFERENCE_KEY = Symbol('conference');

/**
 * The name of the {@code JunctoConnection} property which identifies the location URL where the connection will be made.
 */
export const JUNCTO_CONNECTION_URL_KEY = Symbol('url');
