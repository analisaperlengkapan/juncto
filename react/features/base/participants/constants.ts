 ...
 *
 * XXX (1) Web/React utilizes relativity on the Juncto deployment.
 ...
 */
export const DISCO_REMOTE_CONTROL_FEATURE = 'http://juncto.org/meet/remotecontrol';

/**
 * Icon URL for jungasi participants.
 *
 * @type {string}
 */
