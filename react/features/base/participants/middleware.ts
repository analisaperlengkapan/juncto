...
import { IJunctoParticipant } from './types';
...
MiddlewareRegistry.register(store => next => action => {
    ...
    case LOCAL_PARTICIPANT_RAISE_HAND: {
        ...
        store.dispatch(participantUpdated({
            ...
            // stating the JunctoConference instance (i.e. participant property
    ...
    (conference, store) => {
        if (conference) {
            const propertyHandlers: {
                ...
                'e2ee.enabled': (participant: IJunctoParticipant, value: string) =>
                    _e2eeUpdated(store, conference, participant.getId(), value),
                'features_e2ee': (participant: IJunctoParticipant, value: boolean) =>
                ...
                'features_jungasi': (participant: IJunctoParticipant, value: boolean) =>
                    store.dispatch(participantUpdated({
                        conference,
                        id: participant.getId(),
                        isJungasi: value
                ...
                'features_screen-sharing': (participant: IJunctoParticipant, value: string) =>
                    store.dispatch(participantUpdated({
                        conference,
                        id: participant.getId(),
                        features: { 'screen-sharing': true }
                    })),
                'localRecording': (participant: IJunctoParticipant, value: string) =>
                    _localRecordingUpdated(store, conference, participant.getId(), Boolean(value)),
                'raisedHand': (participant: IJunctoParticipant, value: string) =>
                    _raiseHandUpdated(store, conference, participant.getId(), value),
                'region': (participant: IJunctoParticipant, value: string) =>
                    store.dispatch(participantUpdated({
                        conference,
                        id: participant.getId(),
                        region: value
                    })),
                'remoteControlSessionStatus': (participant: IJunctoParticipant, value: boolean) =>
                    store.dispatch(participantUpdated({
                        conference,
                        id: participant.getId(),
            ...
            conference.on(
                JunctoConferenceEvents.PARTICIPANT_PROPERTY_CHANGED,
                (participant: IJunctoParticipant, propertyName: string, oldValue: string, newValue: string) => {
 ...
 * @returns {void}
 */
function _e2eeUpdated({ getState, dispatch }: IStore, conference: IJunctoConference,
 ...
 * @returns {void}
 */
function _localRecordingUpdated({ dispatch, getState }: IStore, conference: IJunctoConference,
 ...
 * @returns {void}
 */
function _raiseHandUpdated({ dispatch, getState }: IStore, conference: IJunctoConference,
