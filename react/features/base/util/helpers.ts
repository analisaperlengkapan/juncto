 ...
 */
export function getJunctoMeetGlobalNS() {
    if (!window.JunctoMeetJS) {
        window.JunctoMeetJS = {};
    }

    if (!window.JunctoMeetJS.app) {
        window.JunctoMeetJS.app = {};
    }

    return window.JunctoMeetJS.app;
}
 ...
 */
export function getJunctoMeetGlobalNSConnectionTimes() {
    const globalNS = getJunctoMeetGlobalNS();
