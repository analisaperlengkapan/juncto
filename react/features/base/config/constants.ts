 ...
 */
export const DEFAULT_TERMS_URL = 'https://juncto.org/meet/terms';

/**
 * The URL at which the privacy policy is available to the user.
 */
export const DEFAULT_PRIVACY_URL = 'https://juncto.org/meet/privacy';

/**
 * The URL at which the help centre is available to the user.
 */
export const DEFAULT_HELP_CENTRE_URL = 'https://web-cdn.juncto.net/faq/meet-faq.html';
