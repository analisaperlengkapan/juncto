...
export default [
     ...
     * provided by, for example, Juncto SDK for iOS.
     *
     * @type string
     */
    'callDisplayName',
     ...
     * override/overwrite provided by, for example, Juncto SDK for iOS.
     *
     * @type string
     */
    'callHandle',
     ...
     * which Juncto is to work with a CallKit call created outside of Juncto
     * Meet and to be adopted by Juncto such as, for example, an incoming
     * and/or outgoing CallKit call created by Juncto SDK for iOS
     * clients/consumers prior to giving control to Juncto. As the value is
     * associated with a conference/meeting, the value makes sense not as a
     * deployment-wide configuration, only as a runtime configuration
     * override/overwrite provided by, for example, Juncto SDK for iOS.
     *
