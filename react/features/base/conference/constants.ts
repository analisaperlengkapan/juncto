...
/**
 * The name of the {@code JunctoConference} property which identifies the URL of
 * the conference represented by the {@code JunctoConference} instance.
 *
 * TODO It was introduced in a moment of desperation. Juncto SDK for Android
 ...
 * handled. The URL of the {@code JunctoConference} was chosen as the identifier
 ...
 * guaranteed at the time of this writing to match the {@code JunctoConference}
 * instance when the events are to be fired. Patching {@code JunctoConference}
 * from the outside is not cool but it should suffice for now.
 */
export const JUNCTO_CONFERENCE_URL_KEY = Symbol('url');
