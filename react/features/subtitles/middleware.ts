 ...
 */
const TRANSCRIBER_DIAL_NUMBER = 'juncto_meet_transcribe';
...
/**
 * Toggle the local property 'requestingTranscription'. This will cause Juncofo
 * and Jungasi to decide whether the transcriber needs to be in the room.
 *
 * @param {Store} store - The redux store.
...
function _requestingSubtitlesChange(
    ...
    if (enabled && conference?.getTranscriptionStatus() === JunctoMeetJS.constants.transcriptionStatus.OFF
