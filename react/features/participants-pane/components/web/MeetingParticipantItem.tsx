...
function MeetingParticipantItem({
    ...
    useEffect(() => {
        if (_audioTrack && !registeredEvent) {
            ...
            if (junctoTrack) {
                junctoTrack.on(JunctoTrackEvents.TRACK_AUDIO_LEVEL_CHANGED, _updateAudioLevel);
        ...
        return () => {
            if (_audioTrack && registeredEvent) {
                ...
                junctoTrack?.off(JunctoTrackEvents.TRACK_AUDIO_LEVEL_CHANGED, _updateAudioLevel);
            }
        };
    }, [ _audioTrack ]);
