import { querySelector, querySelectorAll } from '@juncto/js-utils/polyfills/querySelectorPolyfill';
...
(global => {
    ...
    //
    // Required by:
    // - lib-juncto requires this if using WebSockets
    ...
    if (typeof global.document === 'undefined') {
        ...
        if (elementPrototype) {
            ...
            //
            // Required by:
            // - lib-juncto ChatRoom#onPresence parsing
        ...
        //
        // Required by:
        // - lib-juncto -> XMLUtils.ts -> parseXML
    ...
    if (typeof global.location === 'undefined') {
        global.location = {
            ...
            // Required by:
            // - lib-juncto/modules/xmpp/xmpp.js
            search: ''
        };
    }
    ...
    if (navigator) {
        ...
        //
        // Required by:
        // - lib-juncto/modules/browser/BrowserDetection.js
        ...
        const sdkVersion = `JunctoMeetSDK/${AppInfo.sdkVersion}${liteTxt}`;
    ...
    if (typeof global.localStorage === 'undefined') {
        global.localStorage = new Storage('@juncto/');
    }
